...
main() {
  ...
  disk_device=$(get_tmux_option "@ukiyo-disk-device" "")
  write_label=$(get_tmux_option "@ukiyo-disk-write-label" " ")
  read_label=$(get_tmux_option "@ukiyo-disk-read-label" " ")
  printf_fmt=$(get_tmux_option "@ukiyo-disk-format" "%4.0fMiB/s")
