...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#{?client_prefix,#[bg=${THEME[cyan]}]#[fg=${THEME[bblack]}]  ,#[dim]#[bg=${THEME[bblack]}]  }#[bold,nodim]"
...
# Unfocused
tmux set -g window-status-format " ${RESET}#[fg=${THEME[bwhite]},bg=default,bold,nodim]  $window_number#W  "
