			...
			textobjects = {
				select = {
					...
					keymaps = {
						...
						["ai"] = { query = "@conditional.outer", desc = "Select outer part of a condition" },
						["ii"] = { query = "@conditional.inner", desc = "Select inner part of a condition" },
